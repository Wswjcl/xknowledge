"""Framework generation and adaptation for knowledge-guided reasoning.
Adapted from XSkill eval/exskill/skill_manager.py
...
from ..prompts.framework import GENERATE_FRAMEWORK_PROMPT, MERGE_FRAMEWORK_PROMPT, FRAMEWORK_REFINE_PROMPT
from ..prompts.query import ADAPT_FRAMEWORK_PROMPT
...
def generate_framework(sample_info: Dict[str, Any], llm: Any, args: Any, ground_truth: str = "") -> Dict[str, Any]:
    """
    ...
    try:
        ...
        prompt = GENERATE_FRAMEWORK_PROMPT.format(
...
def merge_frameworks(existing_content: str, new_skill_contents: List[str], llm: Any, args: Any) -> str:
    """
    ...
    prompt = MERGE_FRAMEWORK_PROMPT.format(
...
def adapt_framework_for_query(base_skill: str, experiences: str, task_description: str, llm: Any, images: Optional[List[Any]] = None) -> str:
    """
    ...
    prompt = ADAPT_FRAMEWORK_PROMPT.format(
...
def refine_framework_document(skill_content: str, llm: Any, skill_path: Optional[str] = None, word_threshold: int = 3000, force_refine: bool = False) -> str:
    """
    ...
    prompt = FRAMEWORK_REFINE_PROMPT.format(
    ...
    try:
        ...
        if refined_content:
            ...
            print(f"  [Skill Refine] Complete: {word_count} 鈫?{new_word_count} words")
...
generate_skill_for_sample = generate_framework
merge_skills = merge_frameworks
adapt_skill_for_task = adapt_framework_for_query
refine_skill_document = refine_framework_document
